...
/**
 * `sgate rules [list | why <concept> | conflicts]` — spec §5.4's governance commands. `diff` (needs the lockfile,
 * a separate slice) and `search` are not implemented here; see `.superpowers/rules-commands-report.md`.
 *
