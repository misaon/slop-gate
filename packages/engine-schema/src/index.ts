...
// Skipped: no published schema to bind to, and a duplicate key a package manager generated is not
// actionable. It is also the largest YAML present — 1,016 ms of immich's 1,689 ms engine, no findings.
