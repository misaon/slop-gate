...
export const CORPUS: readonly CorpusRepo[] = [
  ...
  { name: 'adonis-core', url: 'https://github.com/adonisjs/core', ref: 'develop', side: 'backend', stack: 'adonis' },
  { name: 'trpc', url: 'https://github.com/trpc/trpc', ref: 'main', side: 'backend', stack: 'rpc' },
  { name: 'graphql-js', url: 'https://github.com/graphql/graphql-js', ref: 'main', side: 'backend', stack: 'graphql' },
